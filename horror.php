...
<div id="content">
  ...
  <div class="books">
    ...
    <div class="books">
      ...
      <div class="cart_div">
        <a href="#" onclick="simpleCart.add('name=Abraham Lincoln: Vampire Hunter','price=13.95','image=img/horror books/horrorthumbs2.jpg');return false;"> <img src="img/logos/add.png" alt="Add to Cart" class="add_to_cart"></a>
      </div></div>
      ...
      <div class="books">
        ...
        <div class="cart_div">
          <a href="#" onclick="simpleCart.add('name=The Bad Place','price=19.99','image=img/horror books/horrorthumbs3.jpg');return false;"> <img src="img/logos/add.png" alt="Add to Cart" class="add_to_cart"></a>
        </div></div>
        ...
        <div class="books">
          ...
          <div class="cart_div">
            <a href="#" onclick="simpleCart.add('name=The Birthing House','price=27.25','image=img/horror books/horrorthumbs4.jpg');return false;"> <img src="img/logos/add.png" alt="Add to Cart" class="add_to_cart"></a>
          </div></div>
          ...
          <div class="books">
            ...
            <div class="cart_div">
              <a href="#" onclick="simpleCart.add('name=Blood Groove','price=67.25','image=img/horror books/horrorthumbs5.jpg');return false;"> <img src="img/logos/add.png" alt="Add to Cart" class="add_to_cart"></a>
            </div></div>
            ...
            <div class="books">
              ...
              <div class="cart_div">
                <a href="#" onclick="simpleCart.add('name=Blue Rose Trilogy','price=24.99','image=img/horror books/horrorthumbs6.jpg');return false;"> <img src="img/logos/add.png" alt="Add to Cart" class="add_to_cart"></a>
              </div></div>
              ...
              <div class="books">
                ...
                <div class="cart_div">
                  <a href="#" onclick="simpleCart.add('name=Breed','price=21.00','image=img/horror books/horrorthumbs7.jpg');return false;"> <img src="img/logos/add.png" alt="Add to Cart" class="add_to_cart"></a>
                </div></div>
                ...
                <div class="books">
                  ...
                  <div class="cart_div">
                    <a href="#" onclick="simpleCart.add('name=Callis Rose','price=39.99','image=img/horror books/horrorthumbs8.jpg');return false;"> <img src="img/logos/add.png" alt="Add to Cart" class="add_to_cart"></a>
                  </div></div>
