...
<div id="content" class="text_algin_form">
  <div class="contact_form">
    <h1 class="each_title" >CONTACT US</h1>
    <div class="cotact_details">
      <h2 id="contact_details">Details</h2>
      <p class="cus2">Customer service(Toll Free):</p>
      <p class="p_colour"><img src="img/logos/phon.png" alt="phone_icon">800-878-7323</p>
      <p class="cus2">In the Portland, Oregon area(Press 1): </p>
      <p class="p_colour"><img src="img/logos/phon.png" alt="phone_icon">503-228-4651</p>
    </div>
    <div class="tables">
      <form action="">
