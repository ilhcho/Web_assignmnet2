 ...
 <div id="amazingslider-wrapper-1"class="imgslide1">
  <div id="amazingslider-1" class="imgslide2">
    <ul class="amazingslider-slides" style="display:none;">
      <li><img src="img/index_slide/image1.jpg" alt="" /></li>
      <li><img src="img/index_slide/image2.jpg" alt="" /></li>
      <li><img src="img/index_slide/image3.jpg" alt="" /></li>
...
<div class="books">
  ...
  <div class="books">
    ...
    <div class="cart_div">
     <a href="#" onclick="simpleCart.add('name=Fifty Shades of Grey','price=34.00','image=img/romance books/romancethumbs1.jpg');return false;"> <img src="img/logos/add.png" alt="Add to Cart" class="add_to_cart"></a>
   </div></div>
   ...
   <div class="books">
    ...
    <div class="cart_div">
     <a href="#" onclick="simpleCart.add('name=The Silkworm','price=29.95','image=img/mystery books/mysterythumbs1.jpg');return false;"> <img src="img/logos/add.png" alt="Add to Cart" class="add_to_cart"></a>
   </div></div>
   ...
   <div class="books">
    ...
    <div class="cart_div">
     <a href="#" onclick="simpleCart.add('name=The Baby-Led Weaning','price=15.95','image=img/cooking and food books/cookthumbs.jpg');return false;"> <img src="img/logos/add.png" alt="Add to Cart" class="add_to_cart"></a>
   </div></div>
   ...
   <div class="books">
    ...
    <div class="cart_div">
      <a href="#" onclick="simpleCart.add('name=13 Bullets: A Vampire Tale','price=100.00','image=img/horror books/horrorthumbs1.jpg');return false;"> <img src="img/logos/add.png" alt="Add to Cart" class="add_to_cart"></a>
    </div></div>
    ...
    <div class="books">
     ...
     <div class="books">
      ...
      <div class="cart_div">
       <a href="#" onclick="simpleCart.add('name=Outlander','price=49.99','image=img/romance books/romancethumbs2.jpg');return false;"> <img src="img/logos/add.png" alt="Add to Cart" class="add_to_cart"></a>
     </div></div>
     ...
     <div class="books">
      ...
      <center><span class="price">$13.95USD</span></center>
      <div class="cart_div">
        <a href="#" onclick="simpleCart.add('name=Live by Night','price=13.95','image=img/mystery books/mysterythumbs2.jpg');return false;"> <img src="img/logos/add.png" alt="Add to Cart" class="add_to_cart"></a>
      </div></div>
